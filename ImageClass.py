...
from conda.exports import StringIO

from SimpleCV.base import *
from SimpleCV.Color import *
from SimpleCV.LineScan import *
from numpy import int32, basestring
    ...
    **EXAMPLE**
    ...
    def _rectOverlapROIs(self,top, bottom, pos):
        ...
        and the bottom rectangle's ROI (x,y,w,h)
         ...
         顶部是一个矩形 (w,h)
         底部是一个矩形 (w,h)
         pos 是顶部矩形的左上角相对于底部矩形的左上角
         如果两个矩形不重叠，则方法不返回任何内容。 否则返回顶部矩形的 ROI (x,y,w,h)
         和底部矩形的 ROI (x,y,w,h)
        """
        ...
        def inBounds(self,bootom,tr):  #(w,h), (x,y)
            w=self.bottom.w
            h=self.bottom.h
            x=self.tr.x
            y=self.tr.y
    ...
    def bresenham_line(self,X,Y): #(x,y), (x2,y2)
        """
